...
public class PatientChart_Old {
     ...
     */
    public PatientChart_Old(int weight, int height, int bloodPressure, String reason, String treatment, String prescription) {
        this.weight = weight;
        this.height = height;
