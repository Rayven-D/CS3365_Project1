...
public class User_Old {
     ...
     */
    public User_Old(String firstName, String lastName, int userId, String password, int permissions, String dob, String address, int phoneNumber, int SSN, String healthInsurance, int[] availabilityTimes) {
